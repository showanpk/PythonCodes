...
ASSESSMENT_MAP = {
    ...
    "bodyfatpercentageresult": ("Assessment_BodyComposition", "BodyFatCategory"),
    "bodyfatpercentagescore": ("Assessment_BodyComposition", "BodyFatScore"),
    "visceralfatlevelresult": ("Assessment_BodyComposition", "VisceralFatCategory"),
    "visceralfatlevelscore": ("Assessment_BodyComposition", "VisceralFatScore"),
    "skeletalmusclepercentage": ("Assessment_BodyComposition", "SkeletalMuscleCategory"),
    "skeletalmusclescore": ("Assessment_BodyComposition", "SkeletalMuscleScore"),
