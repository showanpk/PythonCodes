#!/usr/bin/env python3
"""
Saheli CRM - Alum Rock (ARCC) full historical migration V4
========================================================
...
are stored as cancelled sessions and do not create attendance.  "CLOSED SESSION - High Risk Only"
is a restricted live Innerva session, NOT a cancellation.
...
def run_migration(commit:bool,start_filter:Optional[date],end_filter:Optional[date],audit_only:bool=False):
    ...
    print("Saheli CRM - ARCC Full Historical Migration V4")
