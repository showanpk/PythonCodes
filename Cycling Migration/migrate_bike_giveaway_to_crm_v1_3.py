#!/usr/bin/env python3
"""
Saheli CRM - Bike Giveaway Historical Migration V1.3
==================================================
...
V1.3 fixes:
- Keeps all V1.2 safety rules.
- Adds five narrowly-scoped reviewed FULL-member mappings for the remaining
  ambiguous Bike Giveaway rows.
- Every reviewed mapping is locked to exact source row + giveaway + normalized
  name + expected source Wellbeing/email/gender + expected CRM Saheli Card/name.
- If any expected evidence changes, the row becomes REVIEW_* rather than being
  attached to a different participant.
- No participant profile fields are updated by these mappings.
...
def run_migration(commit: bool, audit_only: bool) -> int:
    ...
    print("Saheli CRM - Bike Giveaway Historical Migration V1.3")
