#!/usr/bin/env python3
"""
Saheli CRM - Bike Giveaway Historical Migration V1.2
==================================================
...
V1.2 fixes:
- Preview-created Lite members are not treated as pre-existing identities.
- Same-name/different-Wellbeing-ID rows can remain separate when the CRM had
  no same-name member before the migration.
- An exact one-FULL/one-LITE duplicate pair with the same non-null DOB reuses
  the FULL member without deleting or changing the Lite record.
...
def run_migration(commit: bool, audit_only: bool) -> int:
    ...
    print("Saheli CRM - Bike Giveaway Historical Migration V1.2")
